...
// Nalezení důležitých elementů na stránce pro sekce s datem narození uživatele
...
// Nalezení důležitých elementů na stránce pro sekce s datem narození uživatele
const narozeninyFormularPodruhe = document.querySelector("#narozeniny-formular-podruhe");
...
// Obsluha události odeslání formuláře
narozeninyFormularPodruhe.addEventListener("submit", event => {
	// Zrušení výchozího zpracování události
	event.preventDefault();
